...
echo ""
echo ""
echo "Downloading gun configureation application. This will appear in your settings menu after install. You will need to calibrate the gun prior to gameplay."
sleep 8
...
cp ./utils/gunconf.sh ~/RetroArena/settingsmenu/
echo ""
echo ""
echo "Checking to see if you have any shooters. If not snagging a few to get you started"
cd /home/pigaming/RetroArena/roms/mame-advmame/
if [ ! -f "/home/pigaming/RetroArena/roms/mame-advmame/alien3.zip" ]; then
	wget http://eazyhax.com/pitime/shooter/alien3.zip
fi
if [[ ! -f "/home/pigaming/RetroArena/roms/mame-advmame/le2.zip" ]]; then
	wget http://eazyhax.com/pitime/shooter/le2.zip
fi
if [[ ! -f "/home/pigaming/RetroArena/roms/mame-advmame/duckhunt.zip" ]]; then
